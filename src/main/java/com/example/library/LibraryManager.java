...
public class LibraryManager {
    ...
    public boolean removeBook(String title) {
        for (Book book : library.findBooksByTitle(title)) { // Busca todos los libros que coincidan con el titulo dado.
            if (book.getTitle().equalsIgnoreCase(title)) { // Comprueba si el título coincide.
                return library.removeBook(book); // Elimina el libro si se encuentra una coincidencia.
            }
        }
